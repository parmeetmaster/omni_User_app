...
class AppConstants {
  static const String APP_NAME = 'OMNI Kredi (Kliyan)';
 ...
 // static const String BASE_URL = 'http://credits.omninovas.com';
  ...
  static  List<OnboardModel> onboardList = [
    ...
    OnboardModel(Images.onboard_image_4, Images.onboard_background_4, 'on_boarding_title_4'.tr, 'on_boarding_sub_title_4'.tr),
  ];
}
